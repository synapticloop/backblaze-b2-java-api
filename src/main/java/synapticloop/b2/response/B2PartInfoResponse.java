...
public class B2PartInfoResponse extends BaseB2Response {
	...
	public B2PartInfoResponse(final JSONObject response) throws B2ApiException {
		super(response);
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("B2PartInfoResponse{");
